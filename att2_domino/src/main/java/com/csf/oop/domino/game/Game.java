...
import com.csf.oop.domino.Helpers.JsonHelper;
...
public class Game implements Serializable {
    ...
    public void saveGame() {
        String results = String.format("players: %s, winner: %s", this.players, winner);
        jsonHelper.writeToJSONFile("./src/main/resources/results.json", results);
    }
